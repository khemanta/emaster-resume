...
\fcolorbox{red}{sidebg}{%
    \begin{minipage}[t][\textheight-2\fboxsep-2\fboxrule][t]{\dimexpr0.40\textwidth-2\fboxrule-2\fboxsep\relax}
        ...
        \begin{center}
            \begin{tikzpicture}
            \clip (0,0) circle (2.5cm) node[anchor=center] {\includegraphics[width=5cm]{profile_pic.jpg}}; 
            \end{tikzpicture}
        \end{center}
        \vspace{0.15cm}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \begin{tabularx}{\textwidth}{cY}
            ...
            \faEnvelope{}   & \href{mailto:hemantk22@iitk.ac.in}{hemantk22@iitk.ac.in} \\
